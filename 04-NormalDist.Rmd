...
Complete the writing assignment as outlined in the R Markdown document
for this lab session. Once you've finished, knit the document and submit
the resulting PDF to Canvas.

You'll notice that this assignment contains only 2 questions, as opposed
to the usual 8 in previous labs. This is indicative of the level of
detail and effort expected in your responses. Given their significance,
don't be surprised if these questions reappear in future examinations.

1.  Explain the concept of sampling error (4 points)

2.  Explain why the standard deviation of the sampling distribution of
    mean gets smaller as sample-size increases (4 points)
...
The "grades.csv" file contains 50 students' exam grades (let's say it's
the final exam for a Statistics class).
